package com.saasbeauty.authservice.services; // Asegúrate de que este sea tu paquete de servicios

import com.saasbeauty.authservice.dto.request.user.EmbeddedUserRequestDTO; // Ajusta tu paquete DTO
import com.saasbeauty.authservice.dto.response.UserResponseDTO; // Ajusta tu paquete DTO
import com.saasbeauty.authservice.entities.ListRole; // Ajusta tu paquete entidades
import com.saasbeauty.authservice.entities.User; // Ajusta tu paquete entidades
import com.saasbeauty.authservice.entities.UserRole; // Ajusta tu paquete entidades
import com.saasbeauty.authservice.exceptions.DuplicateResourceException;
...
import com.saasbeauty.authservice.models.UserModel; // Ajusta tu paquete modelos
import com.saasbeauty.authservice.repositories.ListRoleRepository; // Ajusta tu paquete repositorios
import com.saasbeauty.authservice.repositories.UserRepository; // Ajusta tu paquete repositorios
import jakarta.transaction.Transactional; // Correcto usar jakarta.transaction
import lombok.extern.slf4j.Slf4j;
import org.springframework.beans.factory.annotation.Autowired; // Es buena práctica usar @Autowired en el constructor
import org.springframework.security.crypto.password.PasswordEncoder; // Usa la interfaz, no la implementación directamente
import org.springframework.stereotype.Service;

import java.time.LocalDateTime; // Para la fecha de auditoría
